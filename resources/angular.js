  ...
  $scope.submit = function (contactform, e) {
    ...
    if (contactform.$valid) {
      ...
      if ($scope.response === null) { //if string is empty
         ...
         */
        console.log('STARTED SERVER SIDE CAPTCHA VALIDATION');
        $http.post('https://www.google.com/recaptcha/api/siteverify', {
          secret: '6LeLFC0UAAAAAGydkJ0GKYV2pjOdyjtlMzxPCq0X',
